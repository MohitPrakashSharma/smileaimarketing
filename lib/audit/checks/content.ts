...
const CONTENT_CHECKS: CheckDefinition[] = [
  ...
  // ---------- C3 Content quality ----------
  {
    ...
    why: "Pages with a heading and two sentences rarely rank. Google prefers pages that fully answer what a {customer} is looking for.",
  ...
  // ---------- C5 Internal linking ----------
  {
    ...
    why: "Internal links pass authority between pages and show search engines which pages matter. Dead-end pages rank worse.",
