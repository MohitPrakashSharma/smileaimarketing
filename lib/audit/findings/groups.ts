...
const GROUPS: GroupDef[] = [
  ...
  { key: "mobile_html", title: "Mobile and HTML basics are missing", pillar: "TECHNICAL", section: "B4", checkIds: ["tech.mobile.viewport_missing", "tech.html.lang_missing", "tech.html.basics"], why: "Google indexes the mobile version of your site first. Google assesses the mobile version of a page first, so mobile basics affect how every page is evaluated.", fixIntro: "Add the standard viewport, language and charset declarations to the site template.", owner: "developer" },
